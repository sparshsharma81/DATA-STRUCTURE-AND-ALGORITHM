...
public class painter_partision {
    public static void main(String[] args) {
        //this is the painter partision problem or simply split array- largest sum
        /*
         Given K painters to paint N boards where each painter takes 1 unit of time to paint 1 unit of boards i.e.
          if the length of a particular board is 5, it will take 5 units of time to paint the board.
...
Second line contains N which indicates the number of boards.
 Third line contains N space separated integers representing the length of each board.
         */
         ...
         /*
          here the task has to be consecutive...
